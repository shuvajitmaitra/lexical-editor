...
export function EquationPickerPlugin() {
    return new ComponentPickerOption('Equation', {
        ...
        onSelect: (_, editor, showModal) => showModal('Insert Equation', (onClose) => (<InsertEquationDialog activeEditor={editor} onClose={onClose}/>)),
    });
}
//# sourceMappingURL=equation-picker-plugin.jsx.map