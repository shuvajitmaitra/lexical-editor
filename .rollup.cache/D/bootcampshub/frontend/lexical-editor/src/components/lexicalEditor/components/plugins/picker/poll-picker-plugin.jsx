...
export function PollPickerPlugin() {
    return new ComponentPickerOption('Poll', {
        ...
        keywords: ['poll', 'vote'],
        onSelect: (_, editor, showModal) => showModal('Insert Poll', (onClose) => (<InsertPollDialog activeEditor={editor} onClose={onClose}/>)),
    });
}
//# sourceMappingURL=poll-picker-plugin.jsx.map