...
export function ExcalidrawPlugin() {
    ...
    return (<ExcalidrawModal initialElements={[]} initialAppState={{}} initialFiles={{}} isShown={isModalOpen} onDelete={onDelete} onClose={onClose} onSave={onSave} closeOnClickOutside={false}/>);
}
//# sourceMappingURL=excalidraw-plugin.jsx.map