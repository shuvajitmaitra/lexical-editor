...
import { $createInlineImageNode, $isInlineImageNode, InlineImageNode, } from '../nodes/inline-image-node';
...
export function InsertInlineImageDialog({ activeEditor, onClose, onImageUpload, }) {
    ...
    return (<div className="grid gap-4 py-4">
      <div className="grid gap-2">
        ...
        <Input id="image" type="file" onChange={(e) => handleFileChange(e.target.files)} accept="image/*" data-test-id="image-modal-file-upload"/>
      </div>
      ...
      <div className="grid gap-2">
        ...
        <Select defaultValue="left" onValueChange={(value) => setPosition(value)}>
      ...
      <div className="flex items-center space-x-2">
        <Checkbox id="caption" checked={showCaption} onCheckedChange={(checked) => setShowCaption(checked)}/>
...
export function InlineImagePlugin({ onImageUpload, }) {
...
//# sourceMappingURL=inline-image-plugin.jsx.map