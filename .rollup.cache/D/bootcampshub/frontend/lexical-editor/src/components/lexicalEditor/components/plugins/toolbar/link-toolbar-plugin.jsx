...
import { $isRangeSelection, COMMAND_PRIORITY_NORMAL, } from 'lexical';
...
export function LinkToolbarPlugin() {
    ...
    return (<Toggle size={'sm'} variant={'outline'} aria-label="Toggle link" onClick={insertLink}>
      <LinkIcon className="h-4 w-4"/>
    </Toggle>);
}
//# sourceMappingURL=link-toolbar-plugin.jsx.map