...
export function FontFamilyToolbarPlugin() {
    ...
    return (<Select value={fontFamily} onValueChange={(value) => {
            setFontFamily(value);
            handleClick(value);
      ...
      <SelectContent>
        {FONT_FAMILY_OPTIONS.map((option) => (<SelectItem key={option} value={option}>
            {option}
          </SelectItem>))}
      </SelectContent>
    </Select>);
}
//# sourceMappingURL=font-family-toolbar-plugin.jsx.map