...
import { $createParagraphNode, $getNodeByKey, $getSelection, $isRangeSelection, COMMAND_PRIORITY_EDITOR, COMMAND_PRIORITY_LOW, KEY_ARROW_DOWN_COMMAND, KEY_ARROW_LEFT_COMMAND, KEY_ARROW_RIGHT_COMMAND, KEY_ARROW_UP_COMMAND, createCommand, } from 'lexical';
    ...
    return (<>
      <Select onValueChange={setLayout} defaultValue={layout}>
        ...
        <SelectContent className="w-full">
          {LAYOUTS.map(({ label, value }) => (<SelectItem key={value} value={value}>
              {label}
            </SelectItem>))}
        </SelectContent>
      </Select>
...
//# sourceMappingURL=layout-plugin.jsx.map