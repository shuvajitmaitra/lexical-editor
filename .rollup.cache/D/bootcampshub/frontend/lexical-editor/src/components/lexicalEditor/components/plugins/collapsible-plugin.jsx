...
import { $createParagraphNode, $getSelection, $isRangeSelection, COMMAND_PRIORITY_LOW, DELETE_CHARACTER_COMMAND, INSERT_PARAGRAPH_COMMAND, KEY_ARROW_DOWN_COMMAND, KEY_ARROW_LEFT_COMMAND, KEY_ARROW_RIGHT_COMMAND, KEY_ARROW_UP_COMMAND, createCommand, } from 'lexical';
import { $createCollapsibleContainerNode, $isCollapsibleContainerNode, CollapsibleContainerNode, } from '../nodes/collapsible-container-node';
import { $createCollapsibleContentNode, $isCollapsibleContentNode, CollapsibleContentNode, } from '../nodes/collapsible-content-node';
import { $createCollapsibleTitleNode, $isCollapsibleTitleNode, CollapsibleTitleNode, } from '../nodes/collapsible-title-node';
...
//# sourceMappingURL=collapsible-plugin.jsx.map